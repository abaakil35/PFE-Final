...
<nav class="custom-navbar">
    ...
    <div class="right-section">
        <ul>
            ...
            <li><a href="#"><i class="fas fa-building"></i>ista</a></li>
                ...
                <div class="col-md-4">
                    <div class="card news-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">L'ISTA lance une nouvelle formation intensive en développement web full-stack pour répondre aux besoins du marché.</p>
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    ...
                    <div class="mt-3">
                        ...
                        <a href="#"><i class="fas fa-envelope mr-2"></i> contact@ista-exemple.ma</a>
                    </div>
                </div>
